...
import static DAL.QuanLyCuDanDAL.*;
...
public class QuanLyCuDanBLL {
    ...
    public static boolean xuLyXoaCuDan(String maCuDan) {
        return DAL.QuanLyCuDanDAL.xuLyXoaCuDan(maCuDan);
    }
    ...
    public static CuDan findByID(String id) throws SQLException {
        return DAL.QuanLyCuDanDAL.findByID(id);
    }

    //Begin TabThongTinCanho
    public static boolean insertCD_BLL(String macd, JTextField tencd, JTextField ngsinh, JComboBox gioitinh, JTextField sdt, JTextField socmt, JTextField quequan) throws SQLException {
        try {
            boolean gt = false;
            gt = gioitinh.getSelectedItem().toString().equals("Nam");
            ...
            if (DAL.QuanLyCuDanDAL.insertCD_DAL(cd)) {
                return true;
            } else {
                return false;
            }
