...
public class DangNhapUI extends JFrame{
	...
	private void addControl() {
		...
		txtMatKhau=new JPasswordField(19);
	...
	protected void xuLyDangNhap() throws SQLException  {
            NhanVien tk=NhanVienDAL.dangNhap(txtTaiKhoan.getText(), txtMatKhau.getText());
		if (tk==null) {
			JOptionPane.showMessageDialog(null, "Sai Tên hoặc Mật Khẩu ");
                    ...
                    if (tk.isVaiTro()==true) {
                        ...
                        NhanVienGUI nv= new NhanVienGUI(tk);
                        nv.setVisible(true);
                    }
		}
	}
